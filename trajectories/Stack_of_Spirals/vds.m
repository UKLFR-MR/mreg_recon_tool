% THIS CODE IS FROM BRIAN HARGREAVES mrsrl.stanford.edu/~brian/vdspiral/
%
...
% =============== CVS Log Messages ==========================
%	$Log: vds.m,v $
%	Revision 1.2  2014/09/10 08:49:27  jasslaender
%	*** empty log message ***
%
%	Revision 1.1  2012/10/23 13:43:23  jasslaender
%	JA: Code to create stack of spirals trajectories. vds is mostly code of hagreaves
%
...
% JA: This should be the sames as abs((gamma*Gmax) / (1+(2*1i*pi*F*r/N)))
