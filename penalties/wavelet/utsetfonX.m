function [out1,out2,out3,out4] = utsetfonX(opt,in2,in3,in4,in5,in6)
...
%
% Frame = hdls(1) , Large = 340 , High = 86
...
switch opt
    ...
    case 'write'
        ...
        set(in3, ...
                ...
                'FontSize',wstr2numX(get(Ed_font_size,'String')), ...
    ...
    case 'get'
        ...
        out2 = wstr2numX(get(Ed_font_size,'String'));
