function LS = filt2lsX(LoD,HiD,LoR,HiR,outTYPE)
%FILT2LS Filters to liftingX scheme.
%   LS = FILT2LS(LoD,HiD,LoR,HiR) returns the liftingX 
...
[Ha,Ga,Hs,Gs,PRCond,AACond] = filters2lpX('b',LoR,LoD);
