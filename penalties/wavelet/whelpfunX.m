function [out1,out2] = whelpfunX(option,in2,in3,in4)
...
switch option
    ...
    otherwise
      fighelp = wfindobjX('figure','tag',tag_fig_info);
end
...
switch option
    ...
    case 'create'
        ...
        if isempty(fighelp)
            ...
            [nul,nul,win_height] = wfigmngrX('figsizes');
			...
			wfigmngrX('extfig',fighelp,'ExtFig_WH');
...
%---------------------------------------
wfigmngrX('set_FigATTRB',fighelp,mfilename);
