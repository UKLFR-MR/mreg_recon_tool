function varargout = utthrwpdX(option,fig,varargin)
...
switch option
    ...
    case 'up'
        ...
        set(varargin{1}(3:4),'Color',wtbutilsX('colors','linTHR'));
        drawnow;
    ...
    case 'create'
        ...
        [Def_Txt_Height,Def_Btn_Height,Def_Btn_Width,Pop_Min_Width, ...
         sliYProp,Def_FraBkColor,Def_EdiBkColor] = mextglobX('get',...
        ...
        %--------------------------
        colHIST = wtbutilsX('colors','wp1d','hist');
        ud = struct(...
                'toolOPT',toolOPT, ...
        ...
        %------------------------
        bdy = wtbutilsX('utthrwpdX_PREFS','params');        
    ...
    case 'displayPerf'
        ...
        %-----------------------------
        wtitleX('Sorted absolute values of coefs','Parent',axe_perfo)
        ...
        axe_histo = axes(comAxeProp{:},...
                         ...
                         'NextPlot','Replace');
        his       = wgethistX(cfs,nb_bins,'left');
        ...
        axes(axe_histo);
        wplothisX(axe_histo,his,ud.histColor);
        ...
        wtitleX('Histogram of absolute values of coefs','Parent',axe_histo);
    ...
    case 'update_GBL_meth'
        ...
        %------------------------------------------------
        suggthr = varargin{1};
        utthrwpdX('updateTHR',fig,'meth',suggthr);
    ...
    case 'updateBIN'
        ...
        his       = wgethistX(thresVal,nb_bins,'left');
    ...
    case 'updateTHR'
        ...
        switch upd_orig
          ...
          case 'edi'
            new_thresh = wstr2numX(get(edi_sel,'string'));
    ...
    case 'residuals'
        wmoreresX('create',fig,tog_res,[],ud.handleORI,ud.handleTHR,'blocPAR');
