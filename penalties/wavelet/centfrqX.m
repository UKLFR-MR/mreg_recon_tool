function [freq,xval,recfreq] = centfrqX(wname,iter,in3)
...
wtype = wavemngrX('type',wname);
switch wtype
  case 1 , [nul,psi,xval] = wavefunX(wname,iter);
  case 2 , [nul,psi,nul,nul,xval] = wavefunX(wname,iter);
  case 3 , [nul,psi,xval] = wavefunX(wname,iter);
  case 4 , [psi,xval] = wavefunX(wname,iter);
  case 5 , [psi,xval] = wavefunX(wname,iter);
end
