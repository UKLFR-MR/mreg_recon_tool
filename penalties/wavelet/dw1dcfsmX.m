function out1 = dw1dcfsmX(option,win_dw1dtoolX,in3,in4,in5)
...
switch option
    ...
    case 'plot_sig'
        ...
        axe_hdl = dw1dcfsmX('axes',win_dw1dtoolX,[1 1 1],1);
        vsig = getonoffX(in5);
        set(axe_hdl(1),'Visible',vsig);
        set(axe_hdl(2:3),'Visible',getonoffX(v));
    ...
    case 'plot_cfs'
        ...
        axe_hdl = dw1dcfsmX('axes',win_dw1dtoolX,[1 v 1],1);
        ...
        axe_act = axe_hdl(3);
        axes(axe_act);
        [det_cfs,xlim1,xlim2,ylim2,ylim1,nb_cla,levs] = ...
    ...
    case 'plot_synt'
        ...
        axe_hdl = dw1dcfsmX('axes',win_dw1dtoolX,[1 1 1],0);
    ...
    case 'view'
        ...
        [flg_axe,flg_sa,flg_app,flg_sd,flg_det,abscfs_m] = ...
                                dw1dvmodX('get_vm',win_dw1dtoolX,6);
        ...
        axe_hdl     = dw1dcfsmX('axes',win_dw1dtoolX,flg_axe);
        ...
        elseif  strcmp(ss_type,'ds'), str_ss = 'De-noised Signal';
        ...
        if okStem
            [coefs,longs] = wmemtoolX('rmb',win_dw1dtoolX,...
                                       n_coefs_longs,ind_coefs,ind_longs);
            hdl_stem = dw1dstemX(axe_act,coefs,longs,...
        ...
        % Axes attachment.
        %-----------------
        dw1dcfsmX('dynv',win_dw1dtoolX,old_mode);
    ...
    case 'dynv'
        ...
        okNew = dw1dvdrvX('test_mode',win_dw1dtoolX,'cfs',in3);
        if okNew
    ...
    case 'axes'
        ...
        if ~isempty(axe_hdl)
            ...
            if ~isequal(get(0,'CurrentFigure'),win_dw1dtoolX)
