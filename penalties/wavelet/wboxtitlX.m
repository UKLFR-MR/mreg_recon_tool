function [out1,out2,out3] = ...
                wboxtitlX(option,in2,in3,in4,in5,in6,in7,in8,in9,in10)
...
switch option
    case 'create'
        ...
        % out2 = text
        %-----------------------------
        Def_AxeFontSize = mextglobX('get','Def_AxeFontSize');
        if nargin<5
        ...
        [xdata,ydata,pos_txt] = wboxtitlX('compute_pos',...
    ...
    case 'pos'
        ...
        [xdata,ydata,pos_txt] = wboxtitlX('compute_pos',in2,l,t,in4,in5,in6);
    ...
    case 'compute_pos'
        ...
        [xpixl,ypixl] = wfigutilX('prop_size',f,1,1);
        hy    = in5*ypixl;
        dx    = in6*xpixl;
        dy    = in7*ypixl;
        ext   = get(in4,'Extent');
    ...
    case 'set'
        ...
        [xdata,ydata,pos_txt] = wboxtitlX('compute_pos',in2,l,t,in5,in6,in7);
