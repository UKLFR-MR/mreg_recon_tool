function varargout = cbthrw1dX(option,in2,in3,in4,in5,in6)
...
if ~ischar(option)
    ...
    if ecx>tol              % Create line
        ...
        ylim = get(axe,'Ylim');
        cbthrw1dX('plotLV',[fig ; lHu ; lHd],[x x NaN; ylim NaN]);
    else
        if NB_LV==0
            return
        end
...
switch option
    ...
    case 'plotLV'
        ...
        for k=1:NB_int-1;
            ...
            hdl_str = num2mstrX([fig ; lv ; lHu ; lHd]);
    ...
    case 'upd_thrStruct'
        ...
        hmb = wmemtoolX('hmb',fig,n_membloc1);
        if ~isempty(hmb) , wmemtoolX('wmb',fig,n_membloc1,ind_status,1); end
