function varargout = iswt2X(varargin)
...
if argnum==2
    ...
    if rem(nbRows,3)==1
        ...
        errargtX(mfilename,'Invalid size for the first argument!','msg');
...
if ~Ambiguity
    ...
    error('Wavelet:Internal_DEV','*** TO VERIFY ***');
end
...
% INTERNAL FUNCTIONS
%===============================================================%
function y = idwt2XLOC(a,h,v,d,lo_R,hi_R,sy,shift)
