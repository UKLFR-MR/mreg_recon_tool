function cbthrw2dX(option,in2,in3,in4)
...
switch option
    case 'down'
        ...
        argStr   = [num2mstrX(in2) ',' int2str(in3)];
        cba_move = [mfilename '(''move'',' argStr ',' num2mstrX(in4) ');'];
        cba_up   = [mfilename '(''up'',' argStr ');'];
        wtbxappdataX('set',fig,'save_WindowButtonUpFcn',get(fig,'WindowButtonUpFcn'));
    ...
    case 'up'
        ...
        set(in2(5:6),'Color',wtbutilsX('colors','linTHR'));
        mousefrmX(0,'watch');
        drawnow;
        ...
        lev_sel = in2(4);
        sli_lev = in2(7);    
        utthrw2dX('update_thrStruct',fig,dir_sel,lev_sel,new_thresh);
        utthrw2dX('show_LVL_perfos',fig);
        mousefrmX(0,'arrow');
end
