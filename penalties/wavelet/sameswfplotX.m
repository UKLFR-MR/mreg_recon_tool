function sameswfplotX(wname,powMAX)
...
iter = 10;
wavefunX(wname,iter,'plot');
[LoD_A,HiD_A,LoR_A,HiR_A] = wfiltersX(wname);
[Hs,Gs,Ha,Ga,PRCond,AACond] = wave2lpX(wname,powMAX)
[LoD_B,HiD_B,LoR_B,HiR_B] = lp2filters(Ha,Ga,Hs,Gs);
bswfunX(LoD_B,HiD_B,LoR_B,HiR_B,iter,'plot');
