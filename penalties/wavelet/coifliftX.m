function LS = coifliftX(wname)
%COIFLIFT Coiflets liftingX schemes.
%   LS = COIFLIFT(WNAME) returns the liftingX scheme specified
...
switch Num
    ...
    otherwise
        error('Wavelet:Lifting:Invalid_WaveNum','Invalid wavelet number%d.',Num)
end
