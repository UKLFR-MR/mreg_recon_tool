function [APMF_1,APMF_2] = pmf2apmfX(PMF,factMode)
...
%
%   N.B.: PMF = pmf2apmfX(pmf2apmfX(PMF,FactM),FactM)).
...
if cellMODE
    ...
    for k = 1:nbFACT
        [APMF_1{k},APMF_2{k}] = ONE_pmf2apmfX(PMF{k},factMode);
    end
else
    [APMF_1,APMF_2] = ONE_pmf2apmfX(PMF,factMode);
end

%---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---%
function [APMF_1,APMF_2] = ONE_pmf2apmfX(PMF,factMode)
APMF_1 = {};
APMF_2 = {};
len = length(PMF);
PMF = PMF(len:-1:1);
