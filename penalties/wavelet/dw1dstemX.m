function varargout = dw1dstemX(axe,coefs,longs,varargin)
...
if isequal(upper(colors),'WTBX')
   dum = wtbutilsX('colors','app',level);
   dum = dum(1,:);
   colors = [wtbutilsX('colors','det',level) ; dum];
end
