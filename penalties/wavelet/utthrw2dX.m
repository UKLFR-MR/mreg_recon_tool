function varargout = utthrw2dX(option,fig,varargin)
...
switch option
    case 'create'
        ...
        [bdy,d_lev] = wtbutilsX('deno2D_PREFS','params');
        ...
        str_pop_dir = {...
            'Horizontal details coefs', ...
            'Diagonal details coefs',   ...
            'Vertical details coefs'  };
        str_txt_tit = {'Level','Select','Thresh'};
        ...
        switch  toolOPT
          ...
          case 'comp'
            if ud.isbior , str_txt_nor = 'Norm cfs recovery';
            else           str_txt_nor = 'Retained energy';
            end
        ...
        varargout{1} = utthrw2dX('set',fig,'position',{levmin,levmax});
        ...
        for k = 1:2:nbarg
           ...
           switch argType
               case 'position_bis'
                 ...
                 visVal     = ud.visible;
                 handlesAXE = h_GRA_LVL(1,:,levmin:levmax);
                 handlesAXE = findobj(handlesAXE(ishandle(handlesAXE(:))));
                 if isequal(visVal,'on')
                     numMeth = get(pop_met,'value');
                     switch numMeth
               ...
               case 'position'
                 ...
                 [bdy,d_lev,btnHeight] = wtbutilsX('deno2D_PREFS','params');
                 if fullSIZE
                 ...
                 utthrw2dX('visible',fig,ud.visible);
                 if nargout>0
    ...
    case 'update_methName'
        ...
        utthrw2dX('update_by_Caller',fig)
    ...
    case 'update_by_UIC'
        ...
        utthrw2dX('update_thrStruct',fig,dir,level,thresh);
        if isequal(toolOPT,'comp') , utthrw2dX('show_LVL_perfos',fig); end
    ...
    case 'update_LVL_meth'
        ...
        maxTHR = utthrw2dX('get',fig,'maxTHR');
        maxTHR = maxTHR(:,ud.levmin:NB_lev);        
        valTHR = min(valTHR,maxTHR);
        
        utthrw2dX('set',fig,'valTHR',valTHR);
    ...
    case 'residuals'
        wmoreresX('create',fig,tog_res,ud.handleRES,ud.handleORI,ud.handleTHR,'blocPAR');
    ...
    case 'plot_dec'
        ...
        colTHR = wtbutilsX('colors','linTHR');
        ...
        maxval  = num2mstrX(thr_max);
        hdl_str = num2mstrX(...
                    [fig ; pop_dir ; direct ; level ; ...
                     l_min; l_max; h_CMD_LVL(2:3,level)] ...
                     );
        cba_thr_min = ['cbthrw2dX' '(''down'',' hdl_str ',' ...
                                int2str(+1) ',' maxval ');'];
        cba_thr_max = ['cbthrw2dX' '(''down'',' hdl_str ',' ...
                                int2str(-1) ',' maxval ');'];
    ...
    utthrw2dX('update_methName',fig)
    if ~isnan(thr_Val)
        utthrw2dX('set',fig,'valTHR',thr_Val);
        thr_Val = utthrw2dX('get',fig,'valTHR');
        utthrw2dX('update_LVL_meth',fig,thr_Val);
    end
