function [out1,out2] = dw1dsupmX(option,win_dw1dtoolX,in3)
...
switch option
    case 'view'
        ...
        [flg_axe,flg_sa,flg_app,flg_sd,flg_det] = ...
                        dw1dvmodX('get_vm',win_dw1dtoolX,4);
        lev2    = Level_Anal+2;
        ...
        if ~isempty(ind)
            ...
            for k = ind
                str_tit = [str_tit ' ' sprintf('%.0f',k)]; %#ok<AGROW>
            end
        end
        wtitleX(str_tit,'Parent',axe_hdl(1));
        if isempty(det)
            ...
            if isempty(ll)
                ...
                set_ylim = 0;
                x = dw1dfileX('det',win_dw1dtoolX,1:Level_Anal);
            end
        ...
        wtitleX(str_tit,'Parent',axe_hdl(2));

        ax_hdl = axe_hdl(3);
        [rep,ccfs_vm,levs,xlim,nb_cla] = ...
        dw1dmiscX('tst_vm',win_dw1dtoolX,4,ax_hdl,1:Level_Anal);
        ...
        if isempty(img_cfs)
            ...
            wylabelX('Level number','Parent',ax_hdl);
            clear x
            ax_hdl = axe_hdl(4);
        ...
        % Axes attachment.
        %-----------------
        dw1dsupmX('dynv',win_dw1dtoolX,old_mode);
    ...
    case 'dynv'
        % Axes attachment.
        %-----------------
        okNew = dw1dvdrvX('test_mode',win_dw1dtoolX,'sup',in3);
        if okNew>0
    ...
    case 'clear'
        ...
        okNew = dw1dvdrvX('test_mode',win_dw1dtoolX,'sup',new_mode);
        switch okNew
          case 1
