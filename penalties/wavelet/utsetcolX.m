function [out1,out2] = utsetcolX(opt,in2,in3,in4)
...
%    Frame_col  hdls]
%
% Frame = hdls(1) , Large = 340 , High = 72
...
switch opt
    case 'define'
        ...
        action = [mfilename '(''change'',' num2mstrX(out1) ');'];
        ...
        action = [mfilename '(''change_txt'',' num2mstrX(out1) ');'];
...
val = wstr2numX(get(ediHdl,'String'));
