function [out1,out2,out3,out4,out5,out6,out7] = wpposaxeX(win,dim,pos_g,is)
...
[xpixl,ypixl] = wfigutilX('prop_size',win,1,1);
bdx           = bdx*xpixl;
bdy           = bdy*ypixl;
...
% Get Globals.
%-------------
% [Def_Btn_Height,sliYProp] = mextglobX('get','Def_Btn_Height','Sli_YProp');
...
elseif dim==2
    ...
    h_axe_tree = h_axe;
    if nargin==4
        [w_axe,h_axe] = wpropimgX(is,w_axe,h_axe);
    end
    w_axe_pack = w_axe;
    h_axe_pack = h_axe;
    w_axe_sig  = w_axe;
