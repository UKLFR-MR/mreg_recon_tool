function [out1,xval,out3] = intwaveX(wname,in2,in3)
...
switch wtype
  case {1,3} , [phi,psi,xval] = wavefunX(wname,iter);
  case 2     , [phi1,psi1,phi2,psi2,xval] = wavefunX(wname,iter);
  case {4,5} , [psi,xval] = wavefunX(wname,iter);
end
