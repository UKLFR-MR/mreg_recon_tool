function varargout = utthrgblX(option,fig,varargin)
...
switch option
  ...
  otherwise
    ...
    pus_est = handlesUIC(ind);              %#ok<NASGU>
end
...
switch option
    case 'down'
        ...
        drawnow
        argCbstr = [num2mstrX(fig) ',' num2mstrX(varargin{1})];
    ...
    case 'move'
        ...
        [new_rl2scr,new_n0scr,new_thresh_BIS] = ...
                key2infoX(varargin{1}(2),varargin{1}(3),new_thresh,'T');
    ...
    case 'up'
        ...
        set(varargin{1}(4),'Color',wtbutilsX('colors','Col_THR_GBL'));
        drawnow;
    ...
    case 'displayPerf'
        ...
        [Col_LinTHR,Col_LinNOR,Col_LinZER] = wtbutilsX('colors','Col_THR_GBL');
        ...
        argCbstr = [num2mstrX(fig) ',' num2mstrX(handles)];
    ...
    case 'getPerfo'
       ...
       [varargout{1},varargout{2}] = key2infoX(lin_norm,lin_zero,threshold,'T');
    ...
    case 'update_GBL_meth'
        ...
        %------------------------------------------------
        valTHR = varargin{1};
        utthrgblX('updateTHR',fig,'meth',valTHR);
    ...
    case 'update_methName'
        utthrgblX('update_by_Caller',fig)
    ...
    case 'updateTHR'
        ...
        [new_rl2scr,new_n0scr,new_thresh] = ...
                        key2infoX(lin_norm,lin_zero,keyval,keytype);
        set(sli_sel,'value',new_thresh);
    ...
    case 'residuals'
        [handleORI,handleTHR,handleRES] = ...
            utthrgblX('get',fig,'handleORI','handleTHR','handleRES');
