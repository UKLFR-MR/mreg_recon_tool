function [out1,out2,out3,out4,out5,out6,out7,out8] = ...
                dw1dmiscX(option,win_dw1dtoolX,in3,in4,in5,in6)
...
switch option
    case 'col_cfs'
        ...
        out1 = dw1dfileX('cfs_beg',win_dw1dtoolX,levels);
        out4 = size(out1);
        ...
        out2 = xlim1;
        out3 = xlim2;
        out1 = wcodematX(out1,nb_cla,levval,absval);
        out6 = nb_cla;
        out8 = ccfs_vm;
    ...
    case 'tst_vm'
        ...
        ccfs_vm  = dw1dvmodX('ccfs_vm',win_dw1dtoolX,num_mode);
