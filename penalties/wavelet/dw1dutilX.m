function dw1dutilX(option,win_dw1dtoolX,in3,in4)
...
switch option
    case {'clean','enable','set_gui'}
        % Handles of tagged objects.
        %---------------------------
        [m_files,m_save] = wfigmngrX('getmenus',win_dw1dtoolX,'file','save');        
...
switch option
    case 'set_par'
        ...
        %----------------------------
        [Wave_Name,Level_Anal] = cbanaparX('get',win_dw1dtoolX,'wav','lev');
    ...
    case 'clean'
        ...
        switch in3
            case {'load_cfs','synt'}
                str_btn = 'Synthesize';
                cba_btn = ['dw1dmngrX(''synt'',' int2str(win_dw1dtoolX) ');'];

            otherwise        
                str_btn = 'Analyze';
                cba_btn = ['dw1dmngrX(''anal'',' int2str(win_dw1dtoolX) ');'];
        end
        set(pus_anal,'String',xlate(str_btn),'Callback',cba_btn);

        % Writing Synthesized Signal Type.
        %----------------------------------
        wmemtoolX('wmb',win_dw1dtoolX,n_param_anal,ind_ssig_type,'ss');
        ...
        cbanaparX('enable',win_dw1dtoolX,'off');
        ...
        cbcolmapX('enable',win_dw1dtoolX,'off')
        ...
        % Cleaning GUI.
        %--------------
        dw1dvmodX('ch_vm',win_dw1dtoolX,1);
        switch in4
    ...
    case 'set_gui'
        ...
        switch in3
            ...
            case 'synt'
                Level_Anal = wmemtoolX('rmb',win_dw1dtoolX,...
    ...
    case 'enable'
        ...
        switch in3
            case 'load_sig'
                cbcolmapX('enable',win_dw1dtoolX,'off')
                cbanaparX('enable',win_dw1dtoolX,'on');
            ...
            case {'demo','load_dec'}
                cbcolmapX('enable',win_dw1dtoolX,'on')
                cbanaparX('enable',win_dw1dtoolX,'on');
                set([pus_anal,                              ...
            ...
            case {'more_disp','end_more_disp'}
                hdldynV = dynvtoolX('handles',win_dw1dtoolX);
                ...
                cbanaparX('enable',win_dw1dtoolX,ena);
				...
				if isequal(in3,'end_more_disp')
					dynvtoolX('dynvzaxeX_BtnOnOff',win_dw1dtoolX);
				end
        end
