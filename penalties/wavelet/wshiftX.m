...
%   Example 1:
%     x = [1 2 3 4 5];
%     wshiftX('1D',x,1)  % returns [2 3 4 5 1]
%     wshiftX('1D',x,-1) % returns [5 1 2 3 4]
%
%   Example 2:
%     x = [1 2 3;5 6 7];
%     wshiftX('2D',x,[1 1])  % returns [6 7 5;2 3 1]
%     wshiftX('2D',x,[-1,0]) % returns [5 6 7;1 2 3]
