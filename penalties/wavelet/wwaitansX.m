function val = wwaitansX(fig,quest,default,cancel)
...
if Ok_fig , wwaitingX('msg',fig,'Wait ... answer'); end
if cancel 
...
Answer_Quest = deblanklX(Answer_Quest);
...
% End waiting.
%-------------
if Ok_fig , wwaitingX('off',fig); end
