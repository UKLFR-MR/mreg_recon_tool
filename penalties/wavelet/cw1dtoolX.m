function varargout = cw1dtoolX(option,varargin)
...
switch option
    case 'create'
		...
		% Add Help for Tool.
		%------------------
		wfighelpX('addHelpTool',win_tool,'&Continuous Analysis','CW1D_GUI');
        ...
        men_import = uimenu(m_files,...
            ...
            'Callback',['cw1dmngrX(''load'',' str_numwin ',''load_wrks'',0);']...
            );
        ...
        [dy_POS_CCM , dh_CCM , dy_POS_FRA_AXES , dh_FRA_AXES , ...
            chk_Height , pus_Height] = wtbutilsX('cw1d_PREFS');        
        y_low       = toolPos(2);
        ...
        %------------------------------------------------------------------
        y_fra       = pos_rad_SCA(2)+pos_rad_SCA(4)+dy_POS_FRA_AXES;
        h_fra       = 3*chk_Height+dh_FRA_AXES;
        ...
        %-------------------------------------     
        hdl_Re_AXES = cw1dutilX('initPosAxes',win_tool,'real',Pos_Graphic_Area);
