function HDL = wtbarrowX(option,varargin)
%WTBARROW Create Arrows.
%
%  example:
%       hdl = wtbarrowX('create');
%       set(gca,'Xlim',[0,1],'Ylim',[0,1]);
%       pause
%       hdl = wtbarrowX('create','Rotation',pi/2,'Scale',[0.5 0.5],'Color','b');
%       set(gca,'Xlim',[-2,2],'Ylim',[-2,2]);
%       pause
%       hdl = wtbarrowX('create','Translate',[1,0],'Rotation',pi/4,'Scale',[0.5 0.5],'Color','y');
