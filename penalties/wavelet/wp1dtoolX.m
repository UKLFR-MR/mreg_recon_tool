function varargout = wp1dtoolX(option,varargin)
    ...
    case 'create'
        ...
        [win_wptool,pos_win,win_units,str_numwin,...
                pos_frame0,Pos_Graphic_Area] = ...
                    wfigmngrX('create','Wavelet Packets 1-D',...
		...
		% Add Help for Tool.
		%------------------
		wfighelpX('addHelpTool',win_wptool,'&One-Dimensional Analysis','WP1D_GUI');
        ...
        uimenu(m_load,...
            'Label','&Signal', ...
            'Position',1,      ...
            'Callback',['wp1dmngrX(''load_sig'',' str_numwin ');'] ...
            );
        uimenu(m_load,...
            'Label','&Decomposition', ...
            'Position',2, ...
            'Callback',['wp1dmngrX(''load_dec'',' str_numwin ');'] ...
            );
        
        uimenu(m_save,...
            'Label','&Synthesized Signal ',...
            'Position',1,        ...
            'Callback',['wp1dmngrX(''save_synt'',' str_numwin ');'] ...
            );
        uimenu(m_save,...
            'Label','&Decomposition ', ...
            'Position',2,         ...
            'Callback',['wp1dmngrX(''save_dec'',' str_numwin ');'] ...
            );        

        % Submenu of test signals.
        %-------------------------
        beg_call_str = ['wp1dmngrX(''demo'',' str_numwin];
        ...
        uimenu(m_imp_wrks,...
            'Label','Import Signal',...
            'Callback',['wp1dmngrX(''import_sig'',' str_numwin ');'] ...
            );
        uimenu(m_imp_wrks,...
            'Label','Import Decomposition', ...
            'Callback',['wp1dmngrX(''import_dec'',' str_numwin ');'] ...
            );
        
        cb_beg = ['wp1dmngrX(''exp_wrks'',' str_numwin];        
        uimenu(m_exp_wrks,...
        ...
        pos_pop_colm  = [xl, y_low, 18*wx, btn_H_1];
        ...
        %------------------------------
        cba_WPOpt      = 'wptreeopX';
        cba_anal       = ['wp1dmngrX(''anal'',' str_numwin ');'];
        cba_comp       = ['wp1dmngrX(''comp'',' str_numwin ');'];
        cba_deno       = ['wp1dmngrX(''deno'',' str_numwin ');'];
        ...
        [pos_axe_pack,   pos_axe_tree,   pos_axe_cfs,    ...
         ...
         pos_axe_col] =  wpposaxeX(win_wptool,1,Pos_Graphic_Area);
        ...
        %--------------------------
        cbcolmapX('set',win_wptool,'pal',{'cool',default_nbcolors});
