function out1 = wimgcodeX(option,in2,in3,in4,in5,in6)
%WIMGCODE Image coding mode.
%   OUT1 = WIMGCODE(OPTION,IN2,IN3,IN4,IN5,IN6)
              
%   M. Misiti, Y. Misiti, G. Oppenheim, J.M. Poggi 12-Mar-96.
%   Last Revision: 23-Dec-2006.
...
switch option
    case 'get' , 
		if nargin==1
			...
			out1 = wfigmngrX('get_CCM_Menu',in2);
		end
    ...
    case 'cod'
      ...
      if ndims(out1)>2 , out1 = uint8(out1); end
      if nargin==6
          lev = in6(1);
          if lev==0 , return; end
          sx = in6(2:3);
          for k = 1:lev , sx = floor((sx+1)/2); end
          out1 = wkeep2X(out1,sx);
      end
end
